/*==========================================================================*
	...
	Dateiname:		primitives_dome.h
	Beschreibung:	Dome Definition
	Revision:		1
...
#ifndef PRIMITIVESDOME_DEFINED
#define PRIMITIVESDOME_DEFINED
#endif
...
---------------------------------------------------------------------------*/
struct PRIMITIVE_DOME {
//:: Die Membervariablen ....................................................
protected:
	LPDIRECT3DVERTEXBUFFER9		m_pVBdome;
	unsigned int				m_iEdges;
	unsigned int				m_iRows;
	//unsigned int				m_iVertexCount = (m_iEdges+1) * 2 * m_iRows;
	float						m_fRadius;
...
public:
							PRIMITIVE_DOME();
							PRIMITIVE_DOME(PIPED3D2 &in_pPipe, const unsigned int in_iEdges = 16 , const unsigned int in_iRows = 4, const float in_fRadius = 3.f, const float in_fNormalFactor = 1.f);
...
---------------------------------------------------------------------------*/
typedef PRIMITIVE_DOME					DOME;
typedef PRIMITIVE_DOME					*LPDOME;

/*---------------------------------------------------------------------------
	Deklaration der ausgerichteten Datentypen
---------------------------------------------------------------------------*/
/*typedef _ALIGN_16 PRIMITIVE_DOME		DOMEA16;
typedef _ALIGN_16 PRIMITIVE_DOME		*LPDOMEA16;

typedef _ALIGN_32 PRIMITIVE_DOME		DOMEA32;
typedef _ALIGN_32 PRIMITIVE_DOME		*LPDOMEA32;

typedef _CACHEALIGN PRIMITIVE_DOME		DOMEAC;
typedef _CACHEALIGN PRIMITIVE_DOME		*LPDOMEAC;*/