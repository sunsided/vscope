/*==========================================================================*
	...
	Dateiname:		primitives_circle.inl.h
	Beschreibung:	Primitive: Kreis Inline-Funktionen
	Revision:		1
...
VSINLINE PRIMITIVE_CIRCLE::PRIMITIVE_CIRCLE() {
	this->m_CircleVertices = NULL;
	this->m_CircleVB = NULL;
...
VSINLINE void PRIMITIVE_CIRCLE::Release() {
	SAFE_DELETE_ARRAY(this->m_CircleVertices);
	SAFE_RELEASE(m_CircleVB);
}

VSINLINE AABBOX3 PRIMITIVE_CIRCLE::GetAABB() {
